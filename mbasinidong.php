  ...
  <body>
      ...
      <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Mba sini dong</a>
                  </li>
            ...
            <div class="col-sm-12">
                <form action="" method="post">
                 ...
                 <label for="nama">Nama Lengkap :</label>
                  ...
                  <br>
                  <button type="submit" name="kirim" class="btn btn-primary" onclick="return confirm ('Yakin ingin menambah produk ?');">Kirim!</button>
                  <a href="mainmenu.php">
    ...
    function pop(){
      ...
      <?php
        if (isset($_POST['kirim']))
        {
                ...
                $harga=20000*$_POST['durasi'];
                $nopemesanan = $username."sini". date("ymdHis");
                ...
                include "koneksi.php";
                $perintah=mysqli_query($conn,"INSERT INTO pemesanan VALUES ('$nopemesanan', '$username', '$alamat', '','$durasi', '$waktu', NULL, '$harga', '', 'submit', 'sini')");
                if ($perintah)
                {
                    echo "<script>
